...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, text_feature, external_feats, beta, gamma, normalize: bool = False):
        features = self.visual(image, text_feature, external_feats, beta, gamma)
