...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, text_feature, external_feats, beta, gamma, lamda, FSA, normalize: bool = False):
        features = self.visual(image, text_feature, external_feats, beta, gamma, lamda, FSA)
